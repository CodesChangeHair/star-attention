...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., comb=False, vis=False, mode='spatial', num_joints=17, num_frames=81):
        super().__init__()
    ...
    def forward(self, x, vis=False):
        ...
        #     attn = self.Wa.transpose(-2, -1) @ (q * k) * self.scale
...
class TemporalAttention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., comb=False, vis=False):
        ...
        head_dim = dim // num_heads
        # NOTE scale factor was wrong in my original version, can set manually to be compat with prev weights
        self.scale = qk_scale or ((head_dim + 3) * head_dim) ** -0.5
    ...
    def forward(self, x, vis=False):
        ...
        if self.comb==True:
            ...
            # attn = (q @ k.transpose(-2, -1)) * self.scale
            attn = self.Wa @ (q * k).transpose(-2, -1) * self.scale
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., attention=Attention, qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 ...
                 mode='spatial', num_joints=17, num_frames=81):
        super().__init__()
        ...
        self.attn = attention(
            ...
            mode=mode, num_joints=num_joints, num_frames=num_frames)
    ...
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
        ...
        self.STEblocks = nn.ModuleList([
            ...
            Block(
                ...
                mode='spatial', num_joints=num_joints)
        ...
        self.TTEblocks = nn.ModuleList([
            Block(
                ...
                mode='temporal', num_frames=num_frame)
            for i in range(depth)])
    ...
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
        ...
        self.STEblocks = nn.ModuleList([
            ...
            Block(
                ...
                drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, mode='spatial', num_joints=num_joints)
            for i in range(depth)])
